...
import music.blitz.com.blitzplayer.widgets.SquareImageView;
...
public class AlbumArtPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public static class AlbumArtFragment extends Fragment implements ICacheListener {
        private static final String ID = "music.blitz.com.blitzplayer.adapters.AlbumArtPagerAdapter.AlbumArtFragment.ID";
