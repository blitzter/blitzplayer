...
package music.blitz.com.blitzplayer.ui.activities;
...
import music.blitz.com.blitzplayer.IElevenService;
import music.blitz.com.blitzplayer.R;
import music.blitz.com.blitzplayer.adapters.SummarySearchAdapter;
import music.blitz.com.blitzplayer.loaders.WrappedAsyncTaskLoader;
import music.blitz.com.blitzplayer.menu.FragmentMenuItems;
import music.blitz.com.blitzplayer.model.AlbumArtistDetails;
import music.blitz.com.blitzplayer.model.SearchResult;
import music.blitz.com.blitzplayer.model.SearchResult.ResultType;
import music.blitz.com.blitzplayer.provider.SearchHistory;
import music.blitz.com.blitzplayer.recycler.RecycleHolder;
import music.blitz.com.blitzplayer.sectionadapter.SectionAdapter;
import music.blitz.com.blitzplayer.sectionadapter.SectionCreator;
import music.blitz.com.blitzplayer.sectionadapter.SectionCreator.SimpleListLoader;
import music.blitz.com.blitzplayer.sectionadapter.SectionListContainer;
import music.blitz.com.blitzplayer.utils.ApolloUtils;
import music.blitz.com.blitzplayer.utils.MusicUtils;
import music.blitz.com.blitzplayer.utils.MusicUtils.ServiceToken;
import music.blitz.com.blitzplayer.utils.NavUtils;
import music.blitz.com.blitzplayer.utils.PopupMenuHelper;
import music.blitz.com.blitzplayer.utils.SectionCreatorUtils;
import music.blitz.com.blitzplayer.utils.SectionCreatorUtils.IItemCompare;
...
import music.blitz.com.blitzplayer.widgets.NoResultsContainer;
...
import static music.blitz.com.blitzplayer.utils.MusicUtils.mService;
...
public class SearchActivity extends FragmentActivity implements
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        if (!TextUtils.isEmpty(mFilterString)) {
            ...
            int type = getIntent().getIntExtra(SearchManager.APP_DATA, -1);
...
/*        if (mCurrentState != VisibleState.Loading) {
    ...
    public void onItemClick(final AdapterView<?> parent, final View view, final int position,
        ...
        if (mAdapter.isSectionFooter(position)) {
            ...
            intent.putExtra(SearchManager.APP_DATA, item.mType.ordinal());
