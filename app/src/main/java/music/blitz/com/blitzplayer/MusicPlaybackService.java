...
import music.blitz.com.blitzplayer.Config.IdType;
import music.blitz.com.blitzplayer.appwidgets.AppWidgetLarge;
import music.blitz.com.blitzplayer.appwidgets.AppWidgetLargeAlternate;
import music.blitz.com.blitzplayer.appwidgets.AppWidgetSmall;
import music.blitz.com.blitzplayer.cache.ImageCache;
import music.blitz.com.blitzplayer.cache.ImageFetcher;
import music.blitz.com.blitzplayer.provider.MusicPlaybackState;
import music.blitz.com.blitzplayer.provider.RecentStore;
import music.blitz.com.blitzplayer.provider.SongPlayCount;
import music.blitz.com.blitzplayer.service.MusicPlaybackTrack;
import music.blitz.com.blitzplayer.utils.BitmapWithColors;
import music.blitz.com.blitzplayer.utils.Lists;
import music.blitz.com.blitzplayer.utils.PreferenceUtils;
import music.blitz.com.blitzplayer.utils.ShakeDetector;
import music.blitz.com.blitzplayer.utils.SrtManager;
...
public class MusicPlaybackService extends Service {
     ...
     */
    public static final String PLAYSTATE_CHANGED = "music.blitz.com.blitzplayer.playstatechanged";

    /**
     * Indicates that music playback position within
     * a title was changed
     */
    public static final String POSITION_CHANGED = "music.blitz.com.blitzplayer.positionchanged";

    /**
     * Indicates the meta data has changed in some way, like a track change
     */
    public static final String META_CHANGED = "music.blitz.com.blitzplayer.metachanged";

    /**
     * Indicates the queue has been updated
     */
    public static final String QUEUE_CHANGED = "music.blitz.com.blitzplayer.queuechanged";

    /**
     * Indicates the queue has been updated
     */
    public static final String PLAYLIST_CHANGED = "music.blitz.com.blitzplayer.playlistchanged";

    /**
     * Indicates the repeat mode changed
     */
    public static final String REPEATMODE_CHANGED = "music.blitz.com.blitzplayer.repeatmodechanged";

    /**
     * Indicates the shuffle mode changed
     */
    public static final String SHUFFLEMODE_CHANGED = "music.blitz.com.blitzplayer.shufflemodechanged";

    /**
     * Indicates the track fails to play
     */
    public static final String TRACK_ERROR = "music.blitz.com.blitzplayer.trackerror";

    /**
     * For backwards compatibility reasons, also provide sticky
     * broadcasts under the music package
     */
    public static final String ELEVEN_PACKAGE_NAME = "music.blitz.com.blitzplayer";
     ...
     */
    public static final String SERVICECMD = "music.blitz.com.blitzplayer.musicservicecommand";

    /**
     * Called to go toggle between pausing and playing the music
     */
    public static final String TOGGLEPAUSE_ACTION = "music.blitz.com.blitzplayer.togglepause";

    /**
     * Called to go to pause the playback
     */
    public static final String PAUSE_ACTION = "music.blitz.com.blitzplayer.pause";

    /**
     * Called to go to stop the playback
     */
    public static final String STOP_ACTION = "music.blitz.com.blitzplayer.stop";

    /**
     * Called to go to the previous track or the beginning of the track if partway through the track
     */
    public static final String PREVIOUS_ACTION = "music.blitz.com.blitzplayer.previous";

    /**
     * Called to go to the previous track regardless of how far in the current track the playback is
     */
    public static final String PREVIOUS_FORCE_ACTION = "music.blitz.com.blitzplayer.previous.force";

    /**
     * Called to go to the next track
     */
    public static final String NEXT_ACTION = "music.blitz.com.blitzplayer.next";

    /**
     * Called to change the repeat mode
     */
    public static final String REPEAT_ACTION = "music.blitz.com.blitzplayer.repeat";

    /**
     * Called to change the shuffle mode
     */
    public static final String SHUFFLE_ACTION = "music.blitz.com.blitzplayer.shuffle";
     ...
     * changes
     */
    public static final String REFRESH = "music.blitz.com.blitzplayer.refresh";

    /**
     * Used by the alarm intent to shutdown the service after being idle
     */
    private static final String SHUTDOWN = "music.blitz.com.blitzplayer.shutdown";

    /**
     * Called to notify of a timed text
     */
    public static final String NEW_LYRICS = "music.blitz.com.blitzplayer.lyrics";

    /**
     * Called to update the remote control client
     */
    public static final String UPDATE_LOCKSCREEN = "music.blitz.com.blitzplayer.updatelockscreen";
    ...
    private Notification buildNotification() {
        ...
        Intent nowPlayingIntent = new Intent("music.blitz.com.blitzplayer.AUDIO_PLAYER")
        ...
        if (mNotificationManager.getNotificationChannel("fcm_fallback_notification_channel") == null) {
            String channelName = getString(R.string.fcm_fallback_notification_channel_label);
            NotificationChannel channel = new NotificationChannel("fcm_fallback_notification_channel", channelName, NotificationManager.IMPORTANCE_LOW);
            mNotificationManager.createNotificationChannel(channel);
        }



        Notification.Builder builder = new Notification.Builder(this, "fcm_fallback_notification_channel")
